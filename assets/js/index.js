    ...
    animalesCard.innerHTML += `
      <div class="px-3 pb-2">
        <div class="bg-dark text-white">
          ...
          />
          <div>
            <button onclick="playSound('${a.name}')" class="btn btn-secondary w-100">
...
// evento para la previsualización de animal seleccionado
...
// evento para crear un nuevo animal 
btnRegistrar.addEventListener("click", () => {
  ...
  if (name && age && comments) {
    ...
    // crear nuevo animal dependiendo de la información seleccionada
    if (name == 'Leon') {
